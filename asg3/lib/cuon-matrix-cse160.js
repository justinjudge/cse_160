...
class Vector3 {
    ...
    static dot(other1, other2) {
        ...
        let d = v1[0] * v2[0] + v1[1] * v2[1] + v1[2] * v2[2]; // Modify this line to calculate this vector's magnitude.
    ...
    static cross(other1, other2) {
        ...
        const v1 = other1.elements;
        const v2 = other2.elements;
        let v3 = new Vector3([v1[1] * v2[2] - v1[2] * v2[1], - (v1[0] * v2[2] - v1[2] * v2[0]), v1[0] * v2[1] - v1[1] * v2[0]]); // Modify this line to calculate cross product between other1 and other2.
